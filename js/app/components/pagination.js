...
export const pagination = (() => {
    ...
    const buttonAction = (button) => {
        ...
        const next = () => {
            pageNow += perPage;
            button.innerHTML = 'Keyingi' + button.innerHTML;
            process();
        };

        const prev = () => {
            pageNow -= perPage;
            button.innerHTML = button.innerHTML + 'Oldingi';
            process();
        };
    ...
    <i class="fa-solid fa-circle-left me-1"></i>Oldingi
</button>
            </li>
            ...
            <li class="page-item" id="next">
                <button class="page-link rounded-end-4" onclick="undangan.comment.pagination.next(this)" data-offline-disabled="false">
                    Keyingi<i class="fa-solid fa-circle-right ms-1"></i>
                </button>
            </li>
        </ul>`;
